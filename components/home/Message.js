  ...
  return (
    <section className="flex flex-col justify-center items-center w-full px-5 mb-14">
      <div className="flex flex-col justify-center items-center gap-3 lg:w-[75vw] w-full">
        ...
        <form
          onSubmit={onSubmit}
          className="p-5 rounded-lg flex flex-col justify-center items-center gap-2 w-full card"
        >
          <label
            htmlFor="name"
            className="text-[18px] font-semibold self-start text-xl"
          >
            Name
          </label>
          <input
            ...
            className="font-medium px-3 py-2 rounded-md w-full outline-none border-0 inputt"
            required
          />
          <label
            htmlFor="email"
