    ...
    return (
        <section className='flex flex-col justify-center items-center w-full px-5 mb-14'>
            <div className='flex flex-col justify-center items-center gap-3 lg:w-[75vw] w-full'>
                ...
                <Link href='/projects' className='px-3 py-2 font-semibold text-gray-800 bg-slate-200 hover:bg-slate-300 text-[16px] transition ease-in-out rounded-lg mt-2'>More Projects</Link>
            </div>
        </section>
    )
}
