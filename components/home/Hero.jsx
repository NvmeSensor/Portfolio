            ...
            <div className='flex flex-col justify-center items-center gap-3 lg:w-[75vw] w-full'>
                <div className='flex justify-center items-center gap-4 lg:self-start'>
                    <div className='flex flex-col justify-start items-center gap-2'>
                        <h1 className='text-4xl font-semibold text-gray-900 dark:text-slate-100 self-start'>{name}</h1>
                        <h2 className='lg:text-2xl text-xl font-medium text-gray-800 dark:text-slate-200 self-start'>{developer}</h2>
                        <h3 className='text-[18px] font-medium text-gray-800 dark:text-slate-200 self-start'>{tagline}</h3>
                    </div>
                </div>
            </div>
        </section>
