        ...
        <section className='flex flex-col justify-center items-center w-full px-5 mb-14'>
            <div className='flex flex-col justify-center items-center gap-3 lg:w-[75vw] w-full'>
                ...
                <form onSubmit={onSubmit} className='p-5 rounded-lg flex flex-col justify-center items-center gap-2 w-full border-b-2 border-slate-400 card'>
                    <label htmlFor="name" className='text-[18px] text-slate-100 font-medium self-start text-xl'>Name</label>
                    ...
                    <label htmlFor="email" className='text-[18px] text-slate-100 font-medium self-start text-xl'>Email</label>
                    ...
                    <label htmlFor="message" className='text-[18px] text-slate-100 font-medium self-start text-xl'>Message</label>
