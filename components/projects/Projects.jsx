        ...
        <section className='flex flex-col justify-center items-center w-full px-5 py-14'>
            <div className='flex flex-col justify-center items-center gap-3 lg:w-[75vw] w-full'>
                <div className='flex justify-between items-center gap-4 w-full'>
                    <h1 className='text-3xl font-semibold dark:text-slate-300 text-gray-900 flex gap-2 items-center'>Projects</h1>
                    <Link href='/' className='btn text-slate-200 dark:text-gray-800 dark:bg-slate-200 bg-gray-900 dark:hover:bg-slate-300 hover:bg-gray-800 transition ease-in-out font-medium px-2 py-1 rounded-lg m-4'>Home Page</Link>
                </div>
