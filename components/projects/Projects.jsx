        ...
        <section className='flex flex-col justify-center items-center w-full px-5 py-14'>
            <div className='flex flex-col justify-center items-center gap-3 lg:w-[75vw] w-full'>
                <div className='flex justify-between items-center gap-4 w-full'>
                    <h1 className='text-3xl font-semibold   flex gap-2 items-center'>Projects</h1>
                    <Link href='/' className='px-3 py-2 font-semibold text-[16px] text-zinc-800 bg-slate-300 hover:bg-slate-400 transition ease-in-out rounded-lg'>Home Page</Link>
                </div>
